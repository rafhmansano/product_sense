...
export const PARKS_DATA: ParkInfo[] = [
  ...
  },
  {
    ...
    icon: '🌌',
    color: '#6D28D9',
    description: 'Novo mega parque da Universal com 5 mundos tematicos imersivos',
    attractions: [
      { name: 'Celestial Park (area central)', suitability: 'perfeito', description: 'Hub central com jardins, fontes e atrações para toda familia' },
      { name: 'Super Nintendo World - Mario Kart: Bowser\'s Challenge', suitability: 'ok', heightRestriction: 102, description: 'Corrida interativa com AR - minimo 102cm', tip: 'Imperdivel! Ir logo na abertura do parque' },
      { name: 'Super Nintendo World - Yoshi\'s Adventure', suitability: 'perfeito', description: 'Passeio calmo e colorido - perfeito para criancas pequenas', tip: 'Sem restricao de altura - ideal para os pequenos' },
      { name: 'Super Nintendo World - Power-Up Band Activities', suitability: 'perfeito', description: 'Atividades interativas pelo mundo Nintendo - colecionar moedas e selos' },
      { name: 'The Wizarding World - Ministry of Magic', suitability: 'ok', heightRestriction: 102, description: 'Atracao principal de Harry Potter ambientada no Ministerio da Magia - minimo 102cm' },
      { name: 'The Wizarding World - Paris Wizarding Quarter', suitability: 'perfeito', description: 'Area tematica de Paris magica com lojas e restaurantes imersivos' },
      { name: 'How to Train Your Dragon - Isle of Berk', suitability: 'perfeito', description: 'Vila Viking com encontro de dragoes e atividades interativas' },
      { name: 'How to Train Your Dragon - Hiccup\'s Wing Gliders', suitability: 'perfeito', description: 'Voo suave sobre a ilha - adequado para criancas pequenas' },
      { name: 'How to Train Your Dragon - Dragon Racer\'s Rally', suitability: 'ok', heightRestriction: 102, description: 'Montanha-russa familiar - minimo 102cm' },
      { name: 'Dark Universe - Monsters Unchained', suitability: 'cuidado', heightRestriction: 102, description: 'Atracao tematica de monstros classicos - pode assustar criancas sensiveis', tip: 'Avaliar se a crianca lida bem com temas de monstros' },
      { name: 'Dark Universe - Curse of the Werewolf', suitability: 'restrito', heightRestriction: 122, description: 'Montanha-russa intensa - minimo 122cm' },
    ],
    route: [
      { time: '08:00', activity: 'Chegada antes da abertura - posicionar na entrada' },
      { time: '08:30', activity: 'Direto para Super Nintendo World (area mais concorrida)' },
      { time: '09:00', activity: 'Mario Kart: Bowser\'s Challenge + Yoshi\'s Adventure' },
      { time: '10:00', activity: 'Power-Up Band activities e explorar a area Nintendo' },
      { time: '11:00', activity: 'How to Train Your Dragon - Isle of Berk e atracoes' },
      { time: '12:00', activity: 'Almoco em uma das areas tematicas' },
      { time: '13:30', activity: 'Pausa / cochilo no hotel (se necessario para crianca)' },
      { time: '15:30', activity: 'Retorno - Wizarding World: Ministry of Magic + Paris Quarter' },
      { time: '17:00', activity: 'Celestial Park - atracoes e explorar a area central' },
      { time: '18:30', activity: 'Jantar tematico em um dos restaurantes do parque' },
      { time: '20:00', activity: 'Shows noturnos e retorno ao hotel' },
    ],
    tips: [
      'Super Nintendo World: comprar a Power-Up Band (~$40) para experiencia interativa completa',
      'Parque novo = filas longas nos primeiros meses - chegar cedo e essencial',
      'Yoshi\'s Adventure e a melhor atracao para criancas pequenas no parque',
      'Isle of Berk (Como Treinar Seu Dragao) tem encontro com dragoes animatronicos ao vivo',
      'Dark Universe tem tematica de monstros - avaliar se e adequado para criancas sensiveis',
      'Express Pass disponivel e altamente recomendado para evitar filas longas',
      'O parque e maior que os outros da Universal - usar sapato muito confortavel',
      'Starfall Racers (Celestial Park) e uma montanha-russa familiar divertida',
      'Restaurantes tematicos: Toadstool Cafe (Nintendo) e o mais disputado - reservar se possivel',
    ],
  },
  {
    id: 'seaworld',
