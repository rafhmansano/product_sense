...
export const PARKS_DATA: ParkInfo[] = [
  {
    ...
    attractions: [
      ...
      { name: 'TRON Lightcycle / Run', suitability: 'restrito', heightRestriction: 122, description: 'Montanha-russa futurista de alta velocidade. Mín. 122cm. Imperdível para adolescentes e adultos!', tip: 'Filas longas - use Lightning Lane ou vá na abertura' },
    ...
    tips: [
      ...
      'Adolescentes: TRON Lightcycle, Space Mountain e Big Thunder são imperdíveis',
    ],
  },
  {
    id: 'epcot',
    ...
    attractions: [
      ...
      { name: 'Soarin\' Around the World', suitability: 'restrito', heightRestriction: 102, description: 'Simulador de voo panorâmico - mín. 102cm. Sensação de voar sobre paisagens do mundo!' },
  ...
  },
  {
    ...
    attractions: [
      { name: 'Mickey & Minnie\'s Runaway Railway', suitability: 'perfeito', description: 'Aventura animada sem restrição de altura. Toda família se diverte!', tip: 'Tecnologia inovadora - imperdível para todas as idades' },
      ...
      { name: 'Star Wars: Rise of the Resistance', suitability: 'restrito', heightRestriction: 102, description: 'Melhor atração de Star Wars! Mín. 102cm. Experiência imersiva de 18 min.', tip: 'Fila longa - use Lightning Lane ou vá logo cedo!' },
      ...
      { name: 'Star Wars: Galaxy\'s Edge', suitability: 'ok', description: 'Área temática impressionante. Construir sabre de luz e droide é experiência única!' },
    ],
    tips: [
      'Mickey & Minnie\'s Runaway Railway: sem restrição - perfeito para toda família!',
      'Rise of the Resistance: a atração mais concorrida - chegue cedo ou use Lightning Lane',
      ...
      'Galaxy\'s Edge: construir sabre de luz (~$250) é experiência inesquecível para fãs de Star Wars',
      'Adolescentes: Rise of the Resistance, Tower of Terror e Rock \'n\' Roller Coaster são imperdíveis',
  ...
  },
  {
    ...
    attractions: [
      ...
      { name: 'Kali River Rapids', suitability: 'restrito', heightRestriction: 96, description: 'Rafting com quedas d\'água - mín. 96cm. Prepare para se molhar! Divertido no calor.' },
  ...
  },
  {
    ...
    icon: '🎥',
    color: '#0369A1',
    description: 'Parque original com Diagon Alley (Harry Potter), Minions, Simpsons e mais',
    attractions: [
      { name: 'Harry Potter and the Escape from Gringotts', suitability: 'restrito', heightRestriction: 107, description: 'Atração principal de Diagon Alley - mín. 107cm. Montanha-russa indoor com efeitos 3D!', tip: 'Imperdível! Fila longa - ir cedo ou usar Express Pass' },
      { name: 'Harry Potter - Diagon Alley', suitability: 'perfeito', description: 'Área temática incrível - lojas, sorvete, Ollivanders. Todas as idades.' },
      { name: 'Hogwarts Express', suitability: 'perfeito', description: 'Trem que conecta os dois parques - experiência diferente em cada direção', tip: 'Precisa de ingresso Park-to-Park!' },
      { name: 'Hollywood Rip Ride Rockit', suitability: 'restrito', heightRestriction: 130, description: 'Montanha-russa radical com música à sua escolha! Mín. 130cm. Favorita dos adolescentes!' },
      { name: 'Revenge of the Mummy', suitability: 'restrito', heightRestriction: 122, description: 'Montanha-russa indoor no escuro com efeitos de fogo! Mín. 122cm. Emocionante!' },
      { name: 'Transformers: The Ride 3D', suitability: 'restrito', heightRestriction: 102, description: 'Simulador de ação 3D intenso - mín. 102cm. Adolescentes adoram!' },
      { name: 'MEN IN BLACK: Alien Attack', suitability: 'restrito', heightRestriction: 107, description: 'Jogo interativo de tiro laser contra aliens! Mín. 107cm. Divertido para toda família.' },
      { name: 'Race Through New York Starring Jimmy Fallon', suitability: 'cuidado', heightRestriction: 102, description: 'Simulador 3D - mín. 102cm. Fila virtual disponível!' },
      { name: 'The Simpsons Ride', suitability: 'cuidado', heightRestriction: 102, description: 'Simulador com os Simpsons em Springfield - mín. 102cm. Pode causar enjoo.', tip: 'Springfield tem comidas temáticas imperdíveis!' },
      { name: 'Despicable Me Minion Mayhem', suitability: 'cuidado', heightRestriction: 102, description: 'Simulador 3D dos Minions - mín. 102cm. Crianças adoram!' },
      { name: 'E.T. Adventure', suitability: 'perfeito', description: 'Clássico! Passeio de bicicleta voadora - ótimo para todas as idades', tip: 'Ao final, E.T. fala seu nome!' },
      { name: 'DreamWorks Destination', suitability: 'perfeito', description: 'Encontro com Shrek, Kung Fu Panda, Trolls - ótimo para crianças pequenas' },
      { name: 'Woody Woodpecker\'s Nuthouse Coaster', suitability: 'ok', heightRestriction: 91, description: 'Mini montanha-russa para crianças - mín. 91cm. Ótima primeira experiência!' },
      { name: 'Curious George Goes to Town', suitability: 'perfeito', description: 'Playground aquático interativo - crianças pequenas adoram! Prepare para se molhar.' },
    ],
    tips: [
      'Express Pass: recomendado se orçamento permitir - economiza 2-4h de fila',
      'Butterbeer: obrigatório! Versão frozen é a mais popular. Disponível em Diagon Alley',
      'Springfield (área dos Simpsons): ótima para comer - Krusty Burger, Lard Lad Donuts',
      'Crianças pequenas: DreamWorks, E.T. Adventure, Curious George e Woody Woodpecker são os destaques',
      'Adolescentes: Rip Ride Rockit, Mummy, Gringotts e Transformers são imperdíveis',
      'Ollivanders Wand Shop: experiência interativa de escolha de varinha (para todas as idades!)',
      'Varinhas interativas (~$60): ativam efeitos mágicos em pontos especiais de Diagon Alley',
    ],
  },
  {
    ...
    attractions: [
      ...
      { name: 'The Incredible Hulk Coaster', suitability: 'restrito', heightRestriction: 137, description: 'Montanha-russa com lançamento de 0 a 65km/h! Mín. 137cm. Clássica do parque!' },
      { name: 'Jurassic World VelociCoaster', suitability: 'restrito', heightRestriction: 130, description: 'Uma das melhores montanhas-russas do mundo! Mín. 130cm. Imperdível para adolescentes!' },
    ],
    tips: [
      ...
      'Adolescentes: Hagrid\'s, VelociCoaster, Hulk e Forbidden Journey são os destaques do parque',
  ...
  },
  {
    ...
    attractions: [
      ...
      { name: 'Kraken', suitability: 'restrito', heightRestriction: 137, description: 'Montanha-russa sem chão! Mín. 137cm. Uma das mais emocionantes do parque!' },
      { name: 'Ice Breaker', suitability: 'restrito', heightRestriction: 122, description: 'Montanha-russa com lançamento - mín. 122cm. Quatro inversões!' },
    ...
    tips: [
      ...
      'Adolescentes: Mako, Manta, Kraken e Ice Breaker são montanhas-russas de classe mundial!',
